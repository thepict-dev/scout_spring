    ...
    <div class="subWrapper">
        ...
        <div class="subContents">
            ...
            <div class="pagination">
            	<c:if test="${pictVO.pageNumber ne 1}">
            		<a href="/notice?pageNumber=1&search_text=${pictVO.search_text}"><img src="/user_img/first.png" alt=""></a>
            		<a href="/notice?pageNumber=${pictVO.pageNumber - 1 < 1 ? 1 : pictVO.pageNumber - 1}&search_text=${pictVO.search_text}"><img src="/user_img/prev.png" alt=""></a>
            	</c:if>
            	
            	
            	<c:forEach var="i" begin="${pictVO.startPage}" end="${pictVO.endPage}">
					<c:if test="${i eq pictVO.pageNumber}">
						<a href="/notice?pageNumber=${i}&search_text=${pictVO.search_text}" class="active">${i}</a>
					</c:if>
					<c:if test="${i ne pictVO.pageNumber}">
						<a href="/notice?pageNumber=${i}&search_text=${pictVO.search_text}" >${i}</a>
					</c:if>
				</c:forEach>
                
                <c:if test="${pictVO.lastPage ne pictVO.pageNumber}">
					<li><a href="/notice?pageNumber=${pictVO.pageNumber + 1 > pictVO.lastPage ?  pictVO.lastPage : pictVO.pageNumber + 1}&search_text=${pictVO.search_text}"><img src="/user_img/next.png" alt=""></a></li>
					<li><a href="/notice?pageNumber=${pictVO.lastPage}&search_text=${pictVO.search_text}"><img src="/user_img/last.png" alt=""></a></li>
				</c:if>
            </div>
        </div>
    </div>
