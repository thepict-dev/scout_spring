    ...
    <div class="subWrapper">
        ...
        <div class="subContents">
            ...
            <ul class="tabNav organNav rules">
                ...
                <li class="active"><a href="/federation_files?dataid=${vo.dataid}">자료실</a></li>
                ...
                <div class="pagination">
	            	...
	            	<c:forEach var="i" begin="${pictVO.startPage}" end="${pictVO.endPage}">
						<c:if test="${i eq pictVO.pageNumber}">
							<a href="/federation_files?dataid=${pictVO.dataid}&pageNumber=${i}&search_text=${pictVO.search_text}" class="active">${i}</a>
						</c:if>
						<c:if test="${i ne pictVO.pageNumber}">
							<a href="/federation_files?dataid=${pictVO.dataid}&pageNumber=${i}&search_text=${pictVO.search_text}" >${i}</a>
						</c:if>
					</c:forEach>
	                
	                <c:if test="${pictVO.lastPage ne pictVO.pageNumber}">
						<li><a href="/federation_files?dataid=${pictVO.dataid}&pageNumber=${pictVO.pageNumber + 1 > pictVO.lastPage ?  pictVO.lastPage : pictVO.pageNumber + 1}&search_text=${pictVO.search_text}"><img src="/user_img/next.png" alt=""></a></li>
						<li><a href="/federation_files?dataid=${pictVO.dataid}&pageNumber=${pictVO.lastPage}&search_text=${pictVO.search_text}"><img src="/user_img/last.png" alt=""></a></li>
					</c:if>
	            </div>
            </div>
