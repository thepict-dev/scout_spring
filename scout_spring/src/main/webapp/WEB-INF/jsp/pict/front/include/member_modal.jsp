...
<div id="joinMemPopup" class="modalContainer">
    <div class="modalInner lg">
        ...
        <form action="">
	                ...
	                <div class="inputsContainer">
	                    ...
	                    <div class="inputBox">
	                        <p class="inputCaption">회비정산입금일</p>
	                            <div class="inputsAlign">
	                            <input type="date" name="BANKDAY_SCOUT" id="BANKDAY_SCOUT" class="lgThinInput" max="9999-12-31">
	                            <div>
            ...
            <div class="saveBox">
                <input type="checkbox" name="save_scout" id="save_scout"><label for="save_scout">입력한 정보를 최신 신상정보로 갱신</label>
            </div>
